export const LEADERS = [
    {
      ...
      abbr: 'CEO',
      featured: false,
      description: "Anton (Tony) Dahbura received the BSEE, MSEE, and PhD in Electrical Engineering and Computer Science from the Johns Hopkins University in 1981, 1982, and 1984, respectively.\n" +
          "\n" +
